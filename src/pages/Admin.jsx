    ...
    return (
      <div className="space-y-4 animate-pulse">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3].map(i => (
            <div key={i} className="h-32 bg-card border border-border-subtle" />
          ))}
        </div>
      </div>
    )
  ...
  if (!isOrganizer) {
    return (
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
        ...
        <div className="border border-border-subtle bg-card p-8 flex items-center gap-5">
    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border-subtle pb-4">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 px-3 py-1.5 border border-border-subtle text-xs font-bold">
          ...
          <button
            ...
            className={cn(
              ...
              section === key
                ...
                : 'border-transparent text-muted-foreground hover:text-muted-foreground hover:border-border-subtle'
            )}
          >
        ...
        <>
              ...
              <button
                ...
                className={cn(
                  ...
                  category === cat
                    ...
                    : 'bg-card text-muted-foreground border-border-subtle hover:border-foreground'
                )}
              >
                <span>{cat}</span>
                <span className={cn(
          ...
          {isLoading ? (
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="bg-card border border-border-subtle p-5 animate-pulse space-y-3">
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-center py-16 bg-card border border-dashed border-border-subtle"
            >
      ...
      {section === 'resultados' && (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-card border border-border-subtle p-8 text-center">
          <div className="w-16 h-16 border border-border-subtle flex items-center justify-center mx-auto mb-4">
        ...
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="space-y-5">
            ...
            {(form.player1_id || form.player2_id) && (
              <div className="bg-muted p-4 border border-border-subtle">
...
function TeamCard({ team, index, getPlayerName, onEdit, onDelete }) {
  ...
  return (
    <motion.div
      ...
      className="bg-card border border-border-subtle p-4 hover:border-border-subtle transition-colors group"
    >
...
function PlayerSelectGrid({ players, selectedId, player2Id, onSelect, hasAnyParticipants }) {
  if (!hasAnyParticipants) {
    return (
      <div className="text-center py-8 bg-muted border border-dashed border-border-subtle space-y-3">
  ...
  if (players.length === 0) {
    return (
      <div className="text-center py-6 bg-muted border border-dashed border-border-subtle">
            ...
            className={cn(
              ...
              isSelected
                ...
                : isP2
                  ...
                  : 'bg-transparent border-transparent hover:bg-muted hover:border-border-subtle'
            )}
            disabled={isP2}
          >
            ...
            <div className={cn('w-4 h-4 border shrink-0', isSelected ? 'bg-foreground border-foreground' : 'border-border-subtle')}>
              {isSelected && (
