  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div>
          <Label>Deporte</Label>
          <Select value={form.sport} onChange={(e) => onChange('sport', e.target.value)}>
    ...
    <div className="space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <Select value={form.sets_per_match} onChange={(e) => onChange('sets_per_match', parseInt(e.target.value))}>
            <option value={1}>1 set</option>
            <option value={2}>2 sets (al mejor de 3)</option>
          ...
          {form.categories.map((cat) => (
            <div key={cat} className="flex items-center gap-2 mb-2">
              ...
              >
                ...
                <option value="grupos-y-eliminatorias">Grupos + eliminatorias</option>
