    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input value={match.team1} onChange={(e) => setMatch({ ...match, team1: e.target.value })} placeholder="Nombre del equipo" className="mt-1" />
        </div>
        <div>
          <Label className="text-xs text-muted-foreground">Equipo 2</Label>
          <Input value={match.team2} onChange={(e) => setMatch({ ...match, team2: e.target.value })} placeholder="Nombre del equipo" className="mt-1" />
        </div>
      </div>
      <div className="grid grid-cols-3 gap-3">
        <div>
          <Label className="text-xs text-muted-foreground">Sets Eq1</Label>
          <Input type="number" value={match.score1} onChange={(e) => setMatch({ ...match, score1: e.target.value })} className="mt-1" />
        </div>
        <div>
          <Label className="text-xs text-muted-foreground">Sets Eq2</Label>
          <Input type="number" value={match.score2} onChange={(e) => setMatch({ ...match, score2: e.target.value })} className="mt-1" />
        </div>
        <div>
      ...
      <Button onClick={() => saveMatch.mutate({ ...match, league_id: leagueId, category })} disabled={saveMatch.isPending}
